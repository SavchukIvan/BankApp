...
function senderCardOnChanged(event){
	senderCardData = getCardByNumber(senderCard.value);
	summa.removeAttribute("disabled");
	senderCardOnBlur(event);
}
...
senderCard.addEventListener("change", senderCardOnChanged);
